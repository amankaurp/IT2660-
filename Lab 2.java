...
class Lab2 {
  public void linkedList() {
    ...
    progLanguages.add("Java"); progLanguages.add("Python");
    progLanguages.add("JavaScript"); progLanguages.add("C++");
    ...
    Iterator<String> listIter = progLanguages.iterator();
  ...
  public void queue() {
    ...
    q.add("Lala"); q.add("Zozo");
    q.add("Lauren"); q.add("Amina"); q.add("Jassi");
  ...
  public void stack() {
    ...
    System.out.println("Peaking: " + bookStack.peek());
    ...
    System.out.println("Searching: " + bookStack.search("Design Patterns"));
    ...
    for(String book : bookStack) { System.out.println(book); }
  }
}