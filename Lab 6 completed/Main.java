public class Main {
  public static void main(String[] args) {
    ...
    // Step 5: Check for keys and display true/false
    ...
    // Step 6: Print all content (key and value)
    System.out.println("\nMap contents:");
    ...
    // Step 8: Print all values only
    System.out.println("\nValues in the map after removals:");
    for (MyMap.Entry<String, Integer> entry : creditHours.entrySet()) {
